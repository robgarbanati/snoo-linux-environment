...
#ifdef CONFIG_BLK_DEV_W90P910
#define ATA_BA    W90XXXX_VA_ATAPI /* ATA Interface Control */
#define MAX_HWIFS	1
#define ide_default_io_base(index)	(ATA_BA+0x100)
#else
...
{
#ifdef CONFIG_BLK_DEV_W90P910
	io_addr=ATA_BA+0x100;
	ctl_addr=ATA_BA+0x120;
#endif

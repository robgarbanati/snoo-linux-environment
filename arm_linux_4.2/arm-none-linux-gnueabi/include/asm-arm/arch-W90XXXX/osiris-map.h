/* linux/include/asm-arm/arch-w90p910/osiris-map.h
 *
...
/* start peripherals off after the W90P910 */

#define OSIRIS_IOADDR(x)	(W90P910_ADDR((x) + 0x05000000))

#define OSIRIS_PA_CPLD		(W90P910_CS1 | (3<<25))
